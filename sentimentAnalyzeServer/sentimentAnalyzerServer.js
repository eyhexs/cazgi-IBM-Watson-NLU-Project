...
app.get("/text/emotion", (req,res) => {
    const analyzeParams = { 'text': req.query.text, 'features': { 'entities': { 'emotion': true, 'limit': 1 }, 'keywords': { 'emotion': true, 'limit': 1 } } };
...
app.get("/text/sentiment", (req,res) => {
    ...
    const analyzeParams = { 'text': req.query.text, 'features': { 'entities': { 'sentiment': true, 'limit': 1 }, 'keywords': { 'sentiment': true, 'limit': 1 } } };
